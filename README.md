# 🎬🔊 YouTube動画の舞台裏を覗き見！コーデック情報表示拡張機能 🎨✨ (v1.4)
...
**v1.4 での主な新機能＆改善点:**
* **オーバーレイ全体の不透明度、調整可能に！**: ポップアップからオーバーレイ全体の不透明度（背景も文字も！）を調整できるようになりました。動画に溶け込ませたい時も、情報をクッキリ見たい時も、あなたの思いのまま！
* **ポップアップの表示をちょっぴり整形**: 設定項目が増えても、ちゃんと全部見えるようにしました。
* **VP9コーデック、しっかりキャッチ！** (v1.3より継続): 以前は時々見逃してしまっていたVP9コーデックも、より確実に表示できるようになりました。
* **オーバーレイ表示の安定感UP！** (v1.3より継続): 表示開始時のちょっとしたチラつき？だいぶ落ち着いて、よりスムーズに情報をお届けできます。
...
* **Overlay Opacity:** オーバーレイ全体の不透明度を調整 (0%で完全に透明、100%で完全に不透明)。
